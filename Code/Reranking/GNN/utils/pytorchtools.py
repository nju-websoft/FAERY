...
class EarlyStopping:
    ...
    def __call__(self, val_loss, eval_result, model):
        ...
        # if self.best_ndcg_5 is None:
        #     self.best_ndcg_5 = ndcg_score
        #     # self.save_checkpoint(ndcg_score, model, self.ndcg_path)
        # elif ndcg_score > self.best_ndcg_5:
        #     self.best_ndcg_5 = ndcg_score
        #     # self.save_checkpoint(ndcg_score, model, self.ndcg_path)
        #     with open('result/eval_result_best_ndcg.json', 'w') as f:
        #         json.dump(eval_result, f)
